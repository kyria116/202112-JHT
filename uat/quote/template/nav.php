<?
	...
	getall_data($tbl_name, $where_clause, $all_l1_info);
	// show_array($all_product_info);
                ...
                <li class="hamenu">
                    ...
                    <div class="botdes-bx">
                        <div class="b-lis">
                            ...
                            <div class="lisbx">
                                <?for($iii=0;$iii<count($all_l1_info);$iii++){?>
									<a href="special.php?l1_id=<?=$all_l1_info[$iii]['Fmain_id']?>">
										<span class="tw"><?=$all_l1_info[$iii]['menu_name']?></span>
									</a>
								<?}?>
                            </div>
                        </div>
